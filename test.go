...
func (p *Page) save() error {
	...
	return ioutil.WriteFile(filename, p.Body, 0o600)
}
...
func maifn() {
	...
	if *addr {
		...
		err = ioutil.WriteFile("final-port.txt", []byte(l.Addr().String()), 0o644) // @review WebApp:Web Is this a security feature?
		if err != nil {
			log.Fatal(err)
		}
		s := &http.Server{}
